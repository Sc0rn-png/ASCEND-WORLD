    ...
    <div className="space-y-10">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {drops.map((drop) => (
          ...
          >
            {/* Aspect Ratio Image Top Container */}
            ...
            <div className="p-6 pt-2 flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-6 space-y-2">
                  <div className="flex justify-between text-xs font-mono">
                    <span className="text-neutral-500 uppercase tracking-wider">Goal Progress</span>
                    <span className="text-[#00FF87] font-bold">{drop.progressPercent}%</span>
                  </div>
                  <div className="relative w-full h-2.5 bg-[#090A0C] rounded-full overflow-hidden border border-white/5">
                    <div 
                      className="h-full bg-gradient-to-r from-[#00FF87]/80 to-[#00FF87] rounded-full transition-all duration-1000"
              ...
              <div className="pt-6 mt-6 border-t border-white/10 flex items-center justify-between gap-4">
                <div>
                  <span className="block text-[10px] font-mono text-neutral-500 uppercase tracking-widest">Early Access</span>
